...
function classifyWithGemini(sender, subject, snippet, config) {
  var prompt =
    ...
    snippet +
    '\n\n' +
    'Return JSON ONLY: {"canonicalDomain": "07_Community_NonProfit", "subLabel": "Projects/Beekeeping", "confidence": 0.98, "title": "Short Title", "summary": "2 sentence executive summary"}'
