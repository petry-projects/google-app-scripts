...
function classifyWithGemini(sender, subject, snippet, config) {
  var prompt =
    ...
    "3. MARRIAGE & ADULT FAMILY (WinShape, Marriage retreats, Spouse & Primary personal): Classify under '04_Family_Health_School' (sub-label 'Family/DJ-Rachel'). Set category to 'Primary', action to 'keep'.\n" +
