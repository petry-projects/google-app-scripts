...
- Agent code should be placed in a documented folder (e.g., `tools/`, `scripts/`, or similar); record the path in `AGENTS.md` ✅
- Run tests locally: `npm test` (or `npx jest "<agent-folder>/tests"`) ✅
